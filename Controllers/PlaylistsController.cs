...
namespace EmptyMvcProject.Controllers
{
    public class PlaylistsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Type")] Playlist playlist)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Type")] Playlist playlist)
        {
            if (id != playlist.Id)
            {
                return NotFound();
